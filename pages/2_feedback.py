...
def display_feedback_page():
    ...
    elif st.session_state.get("loginned") != True and st.session_state.get("registered") != True:
        st.error("🚨 برای ورود به بخش نظرسنجی باید در پلتفرم ما ثبت نام کنید و یا به اکانت خود ورود کنید")
        st.stop()
# ============ EXECUTION ============
